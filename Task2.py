...
def global_function():
    """
    возвращает числовое значение локальной переменной msg
    :return: локальную переменной msg
    """
    msg = 1

    def local_function():
        """
        Изменяет значение  локальной переменной msg в функции global_function
        """
        nonlocal msg
        msg = 2
