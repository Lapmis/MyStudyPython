...
class Segment:
    ...
    def length(self):
        """
        Вычисляет длину между двумя координатами

        :return: число
        """
        d = ((self.dot2[0] - self.dot1[0])**2 + (self.dot2[1] - self.dot1[1])**2)**0.5
        return round(d, 2)
