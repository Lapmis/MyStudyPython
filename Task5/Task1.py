...
def letter_stat(our_str):
    """
    Возвращает словарь, в виде набора пары "Символ: количество вхождений символа в строке".
    :param our_str: строка, в которой будет подсчитано сколько вхождений имеет каждый символ
    :return: словарь в виде пары "Символ: количество вхождений символа в строке"
    """
    letters = set(our_str)
    letters_dict = {}
    for i in letters:
        point = 0
        point = our_str.count(i)
        letters_dict[i] = point
    return letters_dict
