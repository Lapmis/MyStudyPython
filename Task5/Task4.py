...
def scrabble(word):
    """
    Рассчитывает количество очков полученные за слово
    :param word: слово, по которому рассчитывается количество очков
    :return: количество очков полученное за слово
    """
    alphabet = {'а': 1, 'б': 3, 'в': 1, 'г': 3, 'д': 2, 'е': 1, 'ё': 1, 'ж': 5, 'з': 5, 'и': 1, 'й': 4, 'к': 2, 'л': 2,
