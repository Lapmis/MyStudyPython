...
def everything_for_your_cat(cats_data):
    """
    оптимизирует хранение данных таким образом, чтобы для каждого владельца при выводе отображались всего его животные
    одной  строкой.
    Формат вывода: "Имя_покупателя Фамилия_покупателя: Кличка_котика1, Возраст; ...; Кличка_котикаN, Возраст\n"
    :param cats_data: список кортежей
    :return: строки разбивкой о владельце и всех его домашних животных
    """
    result = {}
    our_str = ""
    for cat in cats_data:
        temp = ', '.join([cat[0], str(cat[1])])
        result.setdefault(' '.join([cat[2], cat[3]]), []).append(temp)
