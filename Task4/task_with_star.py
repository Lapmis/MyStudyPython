...
def max_division_by_3(num):
    ...
    while (num != 0 and num // divider2 > 0):
        IntegerAfterDivision = num // divider1
        RemainderOfTheDivision = num % divider2
        for i in range(10):
            value = IntegerAfterDivision * divider1 + i * divider2 + RemainderOfTheDivision
            if value % 3 == 0:
                lst.append(value)
        divider1 *= 10
        divider2 *= 10
